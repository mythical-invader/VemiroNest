    ...
    if (!order.paymentID) {
        ...
        if (order.user && order.user.email) {
            ...
            <div class="container">
                ...
                <div class="content">
                    <h2>Hello ${order.user.name || 'there'}!</h2>
                    <p>Thank you for shopping with <strong>VemiroNest</strong>. We are excited to let you know that we have successfully received your payment and your order is now being processed.</p>
            ...
            `;
            sendEmail(order.user.email, 'Order Confirmed', message).catch(err => console.error(err));
        }
